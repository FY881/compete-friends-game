...
const AI_SYSTEMS = [
  {
    ...
    prompt: "أنت محلل أداء ذكي لموقع حرب العقول (لعبة مسابقات). حلل كل بيانات اللعبة واللاعبين واعطني تقرير مفصل مع خطط تحسين عملية وkpis واضحة.",
  },
  {
    id: "generator",
    icon: Brain,
  ...
  },
  {
    ...
    prompt: "أنت خبير سيبراني متخصص في أمن التطبيقات. حلل أمان موقع حرب العقول (لعبة مسابقات ويب) وقدم تقريراً شاملاً عن الثغرات والحلول.",
  },
  {
    id: "writer",
    icon: PenTool,
