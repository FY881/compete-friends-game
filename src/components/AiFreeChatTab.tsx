...
const SYSTEM_PROMPT = `أنت الذكاء الاصطناعي الحر والغير مقيد لموقع "حرب العقول" — لعبة مسابقات تنافسية. 
  ...
  const handleUnlock = () => {
    if (code === SECRET_CODE) {
      ...
      setMessages([
        {
          role: "assistant",
          content: `🔥 أهلاً يا مالك! أنا الذكاء الاصطناعي الحر في موقع "حرب العقول".
    ...
    <div className="flex h-[70vh] flex-col gap-4">
      ...
      <div className="flex flex-wrap gap-2">
        {[
          ...
          { icon: Sparkles, label: "تحسين اللعبة", cmd: "اقترح 10 تحسينات سريعة للعبة حرب العقول تزيد التفاعل" },
