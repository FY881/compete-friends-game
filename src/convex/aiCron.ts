...
const JOB_DEFS: JobDef[] = [
  ...
  {
    key: "debate_round",
    name: "مجلس العقول — جولة مناظرة",
    description: "يفتح ملفات مناظرة لخلافات وحدات الذكاء المعلّقة، ويحاورها ثلاثة وزراء (محامٍ، نقيض، سيناتور)، ويصدر حكماً موزوناً يُنفَّذ آلياً عند ثقة عالية.",
    group: "AI",
    intervalMinutes: 60,
    enabled: true,
