...
const UPDATE_NOTES: string[] = [
  "إصلاح جذري لمشكلة «حدثت مشكلة عند تحليل الحزمة»: ملف APK موقّع رقمياً الآن بالتوقيع الرسمي للعبة (v2+v3) — أندرويد يقبل التثبيت مباشرة بدون أي خطأ تحليل.",
  "التنزيل يتحقق من البصمة الرقمية SHA-256 وحجم الملف لكل بايت — أي ملف غير مطابق (صفحة خطأ أو تحميل مقطوع) يُرفض تلقائياً ولا يصل لهاتفك.",
